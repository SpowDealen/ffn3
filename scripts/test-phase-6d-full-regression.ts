...
console.log(`Phase 6D full regression summary: ${JSON.stringify({results, externalEffects: 0})}`);
console.log("Phase 6D full regression tests: OK");
