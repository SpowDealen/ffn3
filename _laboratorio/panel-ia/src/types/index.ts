...
export type EventoSanityOutput = {
  nombre: string;
  slug: SlugValue;
...
export type LuchadorSanityOutput = {
  nombre: string;
  slug: SlugValue;
  apodo?: string;
  imagen?: unknown;
...
export type CombateSanityOutput = {
...
export type CategoriaPesoSanityOutput = {
  nombre: string;
  slug: SlugValue;
  disciplina: ReferenceValue;
  limitePeso: number;
...
export type DisciplinaSanityOutput = {
  nombre: string;
  slug: SlugValue;
  descripcion: string;
  activa: boolean;
