...
export type EditorialCapabilityManifest = {id: string; version: number; description: string; provides: string[]; requires: string[]; effects: EditorialCapabilityEffect[]; risk: EditorialCapabilityRisk; timeoutMs: number; priority: number; maxExecutionsPerRun: number; idempotency?: "read_only" | "keyed" | "store_versioned"};
